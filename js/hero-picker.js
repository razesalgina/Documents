...
const HERO_DATA = [
  /* --- Tank --- */
  { id: 1,  name: 'Akai',       role: 'tank',     image: 'assets/heroes/akai.jpg' },
  { id: 2,  name: 'Atlas',      role: 'tank',     image: 'assets/heroes/atlas.jpg' },
  { id: 3,  name: 'Belerick',   role: 'tank',     image: 'assets/heroes/belerick.jpg' },
  { id: 4,  name: 'Baxia',      role: 'tank',     image: 'assets/heroes/baxia.jpg' },
  { id: 5,  name: 'Edith',      role: 'tank',     image: 'assets/heroes/edith.jpg' },
  { id: 6,  name: 'Franco',     role: 'tank',     image: 'assets/heroes/franco.jpg' },
  { id: 7,  name: 'Gloo',       role: 'tank',     image: 'assets/heroes/gloo.jpg' },
  { id: 8,  name: 'Hylos',      role: 'tank',     image: 'assets/heroes/hylos.jpg' },
  { id: 9,  name: 'Johnson',    role: 'tank',     image: 'assets/heroes/johnson.jpg' },
  { id: 10, name: 'Khufra',     role: 'tank',     image: 'assets/heroes/khufra.jpg' },
  { id: 11, name: 'Minotaur',   role: 'tank',     image: 'assets/heroes/minotaur.jpg' },
  { id: 12, name: 'Tigreal',    role: 'tank',     image: 'assets/heroes/tigreal.jpg' },
  /* --- Fighter --- */
  { id: 13, name: 'Aldous',     role: 'fighter',  image: 'assets/heroes/aldous.jpg' },
  { id: 14, name: 'Alucard',    role: 'fighter',  image: 'assets/heroes/alucard.jpg' },
  { id: 15, name: 'Argus',      role: 'fighter',  image: 'assets/heroes/argus.jpg' },
  { id: 16, name: 'Badang',     role: 'fighter',  image: 'assets/heroes/badang.jpg' },
  { id: 17, name: 'Fredrinn',   role: 'fighter',  image: 'assets/heroes/fredrinn.jpg' },
  { id: 18, name: 'Julian',     role: 'fighter',  image: 'assets/heroes/julian.jpg' },
  { id: 19, name: 'Lapu-Lapu',  role: 'fighter',  image: 'assets/heroes/lapu-lapu.jpg' },
  { id: 20, name: 'Paquito',    role: 'fighter',  image: 'assets/heroes/paquito.jpg' },
  { id: 21, name: 'Roger',      role: 'fighter',  image: 'assets/heroes/roger.jpg' },
  { id: 22, name: 'Thamuz',     role: 'fighter',  image: 'assets/heroes/thamuz.jpg' },
  { id: 23, name: 'X.Borg',     role: 'fighter',  image: 'assets/heroes/xborg.jpg' },
  { id: 24, name: 'Yu Zhong',   role: 'fighter',  image: 'assets/heroes/yuzhong.jpg' },
  /* --- Assassin --- */
  { id: 25, name: 'Fanny',      role: 'assassin', image: 'assets/heroes/fanny.jpg' },
  { id: 26, name: 'Gusion',     role: 'assassin', image: 'assets/heroes/gusion.jpg' },
  { id: 27, name: 'Hanzo',      role: 'assassin', image: 'assets/heroes/hanzo.jpg' },
  { id: 28, name: 'Hayabusa',   role: 'assassin', image: 'assets/heroes/hayabusa.jpg' },
  { id: 29, name: 'Helcurt',    role: 'assassin', image: 'assets/heroes/helcurt.jpg' },
  { id: 30, name: 'Karina',     role: 'assassin', image: 'assets/heroes/karina.jpg' },
  { id: 31, name: 'Lancelot',   role: 'assassin', image: 'assets/heroes/lancelot.jpg' },
  { id: 32, name: 'Natalia',    role: 'assassin', image: 'assets/heroes/natalia.jpg' },
  { id: 33, name: 'Saber',      role: 'assassin', image: 'assets/heroes/saber.jpg' },
  { id: 34, name: 'Selena',     role: 'assassin', image: 'assets/heroes/selena.jpg' },
  /* --- Marksman --- */
  { id: 35, name: 'Beatrix',    role: 'marksman', image: 'assets/heroes/beatrix.jpg' },
  { id: 36, name: 'Brody',      role: 'marksman', image: 'assets/heroes/brody.jpg' },
  { id: 37, name: 'Bruno',      role: 'marksman', image: 'assets/heroes/bruno.jpg' },
  { id: 38, name: 'Clint',      role: 'marksman', image: 'assets/heroes/clint.jpg' },
  { id: 39, name: 'Granger',    role: 'marksman', image: 'assets/heroes/granger.jpg' },
  { id: 40, name: 'Karrie',     role: 'marksman', image: 'assets/heroes/karrie.jpg' },
  { id: 41, name: 'Lesley',     role: 'marksman', image: 'assets/heroes/lesley.jpg' },
  { id: 42, name: 'Melissa',    role: 'marksman', image: 'assets/heroes/melissa.jpg' },
  { id: 43, name: 'Miya',       role: 'marksman', image: 'assets/heroes/miya.jpg' },
  { id: 44, name: 'Wanwan',     role: 'marksman', image: 'assets/heroes/wanwan.jpg' },
  /* --- Mage --- */
  { id: 45, name: 'Alice',      role: 'mage',     image: 'assets/heroes/alice.jpg' },
  { id: 46, name: 'Cecilion',   role: 'mage',     image: 'assets/heroes/cecilion.jpg' },
  { id: 47, name: "Chang'e",    role: 'mage',     image: 'assets/heroes/change.jpg' },
  { id: 48, name: 'Eudora',     role: 'mage',     image: 'assets/heroes/eudora.jpg' },
  { id: 49, name: 'Kagura',     role: 'mage',     image: 'assets/heroes/kagura.jpg' },
  { id: 50, name: 'Lunox',      role: 'mage',     image: 'assets/heroes/lunox.jpg' },
  { id: 51, name: 'Lylia',      role: 'mage',     image: 'assets/heroes/lylia.jpg' },
  { id: 52, name: 'Nana',       role: 'mage',     image: 'assets/heroes/nana.jpg' },
  { id: 53, name: 'Vale',       role: 'mage',     image: 'assets/heroes/vale.jpg' },
  { id: 54, name: 'Yve',        role: 'mage',     image: 'assets/heroes/yve.jpg' },
  /* --- Support --- */
  { id: 55, name: 'Angela',     role: 'support',  image: 'assets/heroes/angela.jpg' },
  { id: 56, name: 'Carmilla',   role: 'support',  image: 'assets/heroes/carmilla.jpg' },
  { id: 57, name: 'Diggie',     role: 'support',  image: 'assets/heroes/diggie.jpg' },
  { id: 58, name: 'Floryn',     role: 'support',  image: 'assets/heroes/floryn.jpg' },
  { id: 59, name: 'Mathilda',   role: 'support',  image: 'assets/heroes/mathilda.jpg' },
  { id: 60, name: 'Rafaela',    role: 'support',  image: 'assets/heroes/rafaela.jpg' },
  { id: 61, name: 'Estes',      role: 'support',  image: 'assets/heroes/estes.jpg' },
  { id: 62, name: 'Faramis',    role: 'support',  image: 'assets/heroes/faramis.jpg' },
];
